...
// Get all baked goods
$stmt = $pdo->prepare("SELECT * FROM product WHERE FK_category_id = 5");
$stmt->execute();
...
>>>>>>> df44d70b2bc007a8f04175963f35127ee4fd3878
        <li><a href="protein_view.php">Protein</a></li>
        <li><a href="dairy_view.php">Dairy</a></li>
        <li class="active"><a href="baked_goods_view.php">Baked Goods</a></li>
