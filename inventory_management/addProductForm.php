                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                  ...
                  <form method="post">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="product_id" id="product_id" placeholder="Assigned by System" value="" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="weight" id="weight" placeholder="Enter Product Weight" value="" required>
                    </div>
                    <div class="form-group">
